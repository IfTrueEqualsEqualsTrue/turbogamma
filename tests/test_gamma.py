...
class TestGamma1d:
    ...
    def test_uniform_dose_offset(self, constant_dose_line):
        ...
        np.testing.assert_allclose(
            gamma_bruteforce_1d(base_dose, offset_dose, dose_tolerance_abs=DOSE_TOLERANCE_ABS).gamma,
    ...
    def test_tradeoff(self):
        ...
        gamma_result = gamma_bruteforce_1d(ref_grid, eval_grid, dose_tolerance_abs=2.0)
...
class TestGamma2d:
    ...
    def test_uniform_dose_offset(self, constant_dose_grid):
        ...
        np.testing.assert_allclose(
            gamma_bruteforce_2d(base_dose, offset_dose, dose_tolerance_abs=DOSE_TOLERANCE_ABS).gamma,
...
class TestGamma3d:
    ...
    def test_uniform_dose_offset(self, constant_dose_volume):
        ...
        np.testing.assert_allclose(
            gamma_bruteforce_3d(base_dose, offset_dose, dose_tolerance_abs=DOSE_TOLERANCE_ABS).gamma,
